  ...
  const NFTChildCard = () => {
    return (
      <div className="asset" key={asset.assetGuid}>
        ...
        {controller && controller._sys.isNFT(asset.assetGuid) && asset.childAssetID && asset.NFTID && (
          <div>
  ...
  const NFTCard = () => {
    return (
      <div className="asset" key={asset.assetGuid}>
        ...
        <div className="asset-id">Asset ID: {asset.assetGuid}</div>
        {controller && controller._sys.isNFT(asset.assetGuid) && asset.baseAssetID && (
  ...
  return (
    <>
      {asset.description.startsWith("https://ipfs.io/ipfs/") ? (
        ...
        <div>
          {controller && controller._sys.isNFT(asset.assetGuid) && asset.baseAssetID && asset.childAssetID ? (
            <NFTChildCard />
          ) : (
            <SPTCard />
          )}
